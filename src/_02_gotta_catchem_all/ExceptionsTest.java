...
class ExceptionsTest {
	...
	public void testDivideByZeroException() {
		try {
			assertEquals(ExceptionMethods.divide(10.0,2.0), 5.0d);
			assertEquals(ExceptionMethods.divide(10.0,0.0), 5.0d);
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void testReverseString() {
		try {
			assertEquals(ExceptionMethods.reverseString("test"), "tset");
